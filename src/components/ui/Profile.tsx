  ...
  return (
    <span
      className={`inline-flex items-center gap-2 px-2.5 py-1.5
        rounded-md text-[11px] sm:text-[12px] font-medium
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Réseaux */}
          <p className="text-[10px] text-white/30 uppercase tracking-widest self-start mb-2.5 font-mono">
            Réseaux
          </p>
          ...
          {/* Stack */}
          <p className="text-[10px] text-white/30 uppercase tracking-widest self-start mb-3 font-mono">
            Stack
          </p>
          ...
          <div className="flex flex-col gap-3.5 w-full">
            {categories.map((cat) => (
              <div key={cat.label} className="w-full">
                <p className="text-[10px] sm:text-[11px] text-white/30 uppercase tracking-widest mb-2 font-mono">
                  {cat.label}
                </p>
